 ...
 *               probabilistic algorithm, which needs allocation, and
 ...
 *--------------------------------------------------------------------
 * Description:  This is an implementation of the "probabilistic
 *               algorithm" from Ryo Ito, Hidenori Kuwakado and
 *               Hatsukazu Tanaka. It will calculate the pixel of the
 *               share images from the pixel in the source file, by
 *               creating basis matrices out of the number of the
 *               share files, in the same way, the deterministic
