 ...
 *--------------------------------------------------------------------
 * Description:  Shares, which will be created from the source image,
 *               will have a greater amount of pixel, as the original
 *               source file. This function calculates the pixel
 *               expansion / the amount of pixel that encrypt a source
 *               pixel in width and height with:
 ...
 *               Since the deterministic algorithm has pixel expansion,
 *               they will be larger than the source file.
 ...
 *--------------------------------------------------------------------
 * Description:  This function will allocate all data of the
 *               deterministic algorithm, which needs allocation, and
 ...
 *--------------------------------------------------------------------
 * Description:  This is an implementation of the "deterministic
 *               algorithm" from Moni Naor and Adi Shamir. It will
 *               calculate the pixel of the share images from the pixel
 *               in the source file, by creating basis matrices out of
 *               the number of the share files.
